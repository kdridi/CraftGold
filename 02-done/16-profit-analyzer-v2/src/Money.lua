...
--
-- CAPSULE 16 FIX:
--   - format() and formatColored() now handle negative amounts
--   - Negative values display with a "-" prefix instead of em dash
...
function Money.formatColored(copper)
    ...
    if type(copper) ~= "number" then return "|cff808080—|r" end
